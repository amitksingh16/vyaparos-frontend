    ...
    return (
        ...
        >
            ...
            <button
                onClick={onAction}
                disabled={isDisabled}
                className={`mt-5 inline-flex items-center gap-2 rounded-xl px-4 py-2.5 text-sm font-semibold transition-all duration-200 ${
                    isDisabled
                        ? 'cursor-not-allowed bg-slate-100 text-slate-400'
                        : isActive
                            ? 'bg-[#0A2C4B] text-white shadow-lg shadow-[#0A2C4B]/15 hover:-translate-y-0.5 hover:bg-[#08304F]'
